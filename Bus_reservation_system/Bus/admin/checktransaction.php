...
<?php
  include ('../dbconnect.php');
  $searchq = mysqli_query($connection,"SELECT * FROM transactions");
  ...
  if(count($results)>=1)
  {
    ...
    echo "<table>";
    echo "<tr>"."<th>"."Ticket ID"."</th>"."<th>"."Ticket Number"."</th>"."<th>"."User Id"."</th>"."<th>"."Date"."</th>"."<th>"."Time."."</th>"."<th>"."Fare"."</th>"."</tr>";
    while($results = mysqli_fetch_array($searchq)){
      echo "<tr>"."<td>".$results['tid']."</td>"."<td>".$results['TicketNo']."</td>"."<td>".$results['userid']."</td>"."<td>".$results['date']."</td>"."<td>".$results['time']."</td>"."<td>".$results['fare']."</td>"."</tr>";

  }
  echo "</table>";
}
  else {
    echo "<div style='text-align:center'>"."<b>"."No Transactions"."</b>"."</div>";
  }
