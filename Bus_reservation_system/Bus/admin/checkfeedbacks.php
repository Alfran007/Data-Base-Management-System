...
<?php
  include ('../dbconnect.php');
  $searchq = mysqli_query($connection,"SELECT * FROM feedback");
  ...
  if(count($results)>=1)
  {
    ...
    echo "<table>";
    echo "<tr>"."<th>"."Email"."</th>"."<th>"."Feedback"."</th>"."<th>"."Date"."</th>"."<th>"."Time"."</th>"."</tr>";
    while($results = mysqli_fetch_array($searchq)){
      echo "<tr>"."<td>".$results['Email']."</td>"."<td>".$results['Feedback']."</td>"."<td>".$results['Date']."</td>"."<td>".$results['Time']."</td>"."</tr>";

  }
  echo "</table>";
}
  else {
    echo "<div style='text-align:center'>"."<b>"."No Feedbacks"."</b>"."</div>";
  }
