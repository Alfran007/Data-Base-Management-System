...
<?php
  include ('../dbconnect.php');
  $searchq = mysqli_query($connection,"SELECT * FROM route");
  ...
  if(count($results)>=1)
  {
    ...
    echo "<table>";
    echo "<tr>"."<th>"."Route Number"."</th>"."<th>"."Source"."</th>"."<th>"."Destination"."</th>"."</tr>";
    while($results = mysqli_fetch_array($searchq)){
      echo "<tr>"."<td>".$results['routeno']."</td>"."<td>".$results['source']."</td>"."<td>".$results['destination']."</td>"."</tr>";

  }
  echo "</table>";
}
  else {
    echo "<div style='text-align:center'>"."<b>"."No Routes"."</b>"."</div>";
  }
