...
<?php
  include ('../dbconnect.php');
  $searchq = mysqli_query($connection,"SELECT * FROM user");
  ...
  if(count($results)>=1)
  {
    ...
    echo "<table>";
    echo "<tr>"."<th>"."Email"."</th>"."<th>"."Mobile"."</th>"."<th>"."Password"."</th>"."</tr>";
    while($results = mysqli_fetch_array($searchq)){
      echo "<tr>"."<td>".$results['Email']."</td>"."<td>".$results['Mobile']."</td>"."<td>".$results['Password']."</td>"."</tr>";

  }
  echo "</table>";
}
  else {
    echo "<div style='text-align:center'>"."<b>"."No Users"."</b>"."</div>";
  }
