...
<?php
  include ('../dbconnect.php');
  $searchq = mysqli_query($connection,"SELECT * FROM book");
  ...
  if(count($results)>=1)
  {
    ...
    echo "<table>";
    echo "<tr>"."<th>"."Ticket Number"."</th>"."<th>"."Bus Number"."</th>"."<th>"."User Id"."</th>"."<th>"."Name"."</th>"."<th>"."Mobile Number"."</th>"."<th>"."Age"."</th>"."<th>"."Sex"."</th>"."<th>"."Date"."</th>"."<th>"."Time"."</th>"."<th>"."Unique ID"."</th>"."</tr>";
    while($results = mysqli_fetch_array($searchq)){
      echo "<tr>"."<td>".$results['TicketNo']."</td>"."<td>".$results['busno']."</td>"."<td>".$results['userid']."</td>"."<td>".$results['name']."</td>"."<td>".$results['mobileno']."</td>"."<td>".$results['age']."</td>"."<td>".$results['sex']."</td>"."<td>".$results['date']."</td>"."<td>".$results['time']."</td>"."<td>".$results['uid']."</td>"."</tr>";

  }
  echo "</table>";
}
  else {
    echo "<div style='text-align:center'>"."<b>"."No Bookings Done Yet"."</b>"."</div>";
  }
